...
namespace Storage.DomainService.Services
{
    public interface IContentDiscoveryService
    {
        ...
        Task<VisibleChildrenPage> GetContentAsync(string? parentDirectoryId, StructureType? type = null, string? search = null, string? cursor = null, int limit = 50, CancellationToken cancellationToken = default);
