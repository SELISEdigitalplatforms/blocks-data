...
export default function SecretManagementPage() {
  ...
  const [isMagicUrlConfigDialogOpen, setIsMagicUrlConfigDialogOpen] =
    useState(false);
  const [isManagedServicesGuideOpen, setIsManagedServicesGuideOpen] =
    useState(false);
      ...
      >
            ...
            {selectedTab === "magic-url" && (
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setIsMagicUrlConfigDialogOpen(true)}
                >
        ...
        <TabsContent value="infra-config">
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              Manage your infrastructure configurations
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="my-secret">
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              Manage your secrets and credentials
            </p>
          </div>
        </TabsContent>
