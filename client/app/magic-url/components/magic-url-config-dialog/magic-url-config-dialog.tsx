...
import { ISaveMagicUrlConfigPayload } from "@/magic-url/models/magic-url-config.model";
import { useGetMagicUrlConfig } from "@/magic-url/hooks/use-magic-url";
import { useQueryClient } from "@tanstack/react-query";
import { showErrorToast, showSuccessToast } from "@/hooks/use-toast";
import { getDefaultShortUrlBase, isValidUrl } from "@/magic-url/utils/url.util";
