...
import type { IGetFileByFileIDResponse } from "@blocks-storage/models/storage.model";
...
export default function ExportSchemaModal({ onClose }: { onClose: () => void }) {
  ...
  /** Backend emits the same UILM hub method name as localization export (`language-import-export`). */
