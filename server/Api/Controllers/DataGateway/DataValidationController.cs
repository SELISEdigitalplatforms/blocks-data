...
namespace Api.Controllers
{
    ...
    public class DataValidationController : ControllerBase
    {
        ...
        [HttpGet]
        [ProtectedEndPoint("data::data-validation::get-data-validations")]
        ...
        [HttpGet("get-by-id")]
        [ProtectedEndPoint("data::data-validation::get-data-validation-by-id")]
        ...
        [ProtectedEndPoint("data::data-validation::get-validations-by-schema-id")]
        ...
        [ProtectedEndPoint("data::data-validation::get-validation-by-schema-and-field")]
        [ProducesResponseType(typeof(ServiceResponse<DataValidationResponse>), StatusCodes.Status200OK)]
        ...
        [HttpPost]
        [ProtectedEndPoint("data::data-validation::create-data-validation")]
        ...
        [HttpPut]
        [ProtectedEndPoint("data::data-validation::update-data-validation")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [HttpDelete]
        [ProtectedEndPoint("data::data-validation::delete-data-validation")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
