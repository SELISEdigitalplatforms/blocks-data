# Contributing to blocks-storage-next-sub

Thank you for your interest in contributing to **blocks-storage-next-sub**! Your contributions help improve this project for everyone. Whether you're reporting a bug, suggesting an enhancement, or submitting code changes, we welcome your input.
...
If you encounter a bug or any issue, please report it by [opening an issue](https://github.com/SELISEdigitalplatforms/blocks-storage-next-sub/issues/new) and include the following details:
...
2. **Clone Your Fork**: Clone your forked repository to your local machine.
   ```bash
   git clone https://github.com/your-username/blocks-storage-next-sub.git
   cd blocks-storage-next-sub
   ```
...
```
feat(storage): add sftp provider support - issue(#512)

- add SftpStorage strategy type and credential fields to storage model
- update StorageConfiguration.save() to clear stale fields for sftp
- add useGetStorageConfigurations test coverage for sftp scenario
```
