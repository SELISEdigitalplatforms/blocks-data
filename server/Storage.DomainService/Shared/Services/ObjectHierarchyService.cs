...
namespace Storage.DomainService.Services
{
    ...
    /// </summary>
    /// <remarks>
    /// Placed alongside the other object services rather than on
    ...
    /// </remarks>
    public class ObjectHierarchyService : IObjectHierarchyService
    {
        /// <summary>
        ...
        public ObjectHierarchyService(IDbContextProvider dbContextProvider,
            IObjectAccessResolver? resolver = null, IObjectAccessRepository? accessRepository = null,
        ...
        public async Task<MoveDirectoryResult> MoveDirectoryAsync(string directoryId, string? newParentId, CancellationToken cancellationToken = default)
        {
            ...
            if (!await AuthorizeMoveAsync(directory, ObjectPermission.Delete, cancellationToken))
            ...
            if (!string.IsNullOrEmpty(newParentId))
            {
                ...
                if (!await AuthorizeMoveAsync(target, ObjectPermission.Edit, cancellationToken))
                    return MoveDirectoryResult.NotPermitted;
        ...
        private async Task<bool> AuthorizeMoveAsync(FileDirectory directory, ObjectPermission permission, CancellationToken cancellationToken)
        {
            ...
            var granted = await _resolver.ResolveAsync(new ObjectResourceDescriptor
            {
