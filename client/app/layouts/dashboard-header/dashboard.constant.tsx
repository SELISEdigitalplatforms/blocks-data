...
export const SELISE_APPS: BlocksApp[] = [
  {
    key: "iam",
    label: "IAM",
  ...
  },
  {
    ...
    redirectUri:
      window.process?.env.BLOCKS_LOCALIZATION_DASHBOARD_CALLBACK_URL || "",
  },
  {
    key: "agents",
    label: "Agents",
  ...
  },
  {
    ...
    redirectUri:
      window.process?.env.BLOCKS_UTILITIES_DASHBOARD_CALLBACK_URL || "",
  },
  {
    key: "logic",
    label: "Logic",
  ...
  },
  {
    ...
    redirectUri:
      window.process?.env.BLOCKS_MONITOR_DASHBOARD_CALLBACK_URL || "",
  },
  {
    key: "release",
    label: "Release",
    ...
    redirectUri:
      window.process?.env.BLOCKS_RELEASE_DASHBOARD_CALLBACK_URL || "",
  },
];
