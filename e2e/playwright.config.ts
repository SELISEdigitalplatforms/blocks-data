...
export default defineConfig({
  ...
  // One command runs everything: start the API, wait until baseURL responds,
  // run the tests, then tear the server down.
  ...
  ...(autoStartServer
    ? {
        webServer: {
          ...
          env: {
            FrontendRuntime__BLOCKS_DATA_BASE_URL: baseURL,
          },
        },
      }
    : {}),
