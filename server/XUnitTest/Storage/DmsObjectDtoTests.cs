...
/// error.
/// </summary>
public class DmsObjectDtoTests
{
    [Fact]
    ...
    public void A_grant_request_defaults_to_allow_rather_than_deny()
    {
        ...
        new GrantAccessRequest().Effect.Should().Be(ObjectEffect.Allow);
    }
    ...
    public void Optional_request_fields_start_empty()
    {
        ...
        var search = new ObjectSearchRequest { Query = "report" };
    ...
    public void ObjectKind_MapsTheApiKindStringOntoTheStructureType(string? value, StructureType? expected)
    {
        ObjectKind.FromApiString(value).Should().Be(expected);
    }
}
