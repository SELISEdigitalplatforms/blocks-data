...
namespace Api.Controllers
{
    ...
    public class SchemaController : ControllerBase
    {
        ...
        [HttpGet]
        [ProtectedEndPoint("data::schema::get-schema-definitions")]
        ...
        [HttpGet("aggregation")]
        [ProtectedEndPoint("data::schema::get-schema-definitions-summary")]
        ...
        [HttpGet("get-by-id")]
        [ProtectedEndPoint("data::schema::get-schema-definition-by-id")]
        ...
        [ProtectedEndPoint("data::schema::get-unadapted-change-logs")]
        ...
        /// </summary>
        [HttpGet("info")]
        [ProtectedEndPoint("data::schema::get-entity-collections")]
        ...
        [ProtectedEndPoint("data::schema::get-entity-collection-by-name")]
        ...
        [HttpPost("define")]
        [ProtectedEndPoint("data::schema::create-schema-definition")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [HttpPost("info")]
        [ProtectedEndPoint("data::schema::create-schema")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        /// <returns>Returns a success response if the fields are saved, or an error message if the operation fails.</returns>
        [HttpPost("fields")]
        [ProtectedEndPoint("data::schema::save-schema-fields")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [HttpPut("define")]
        [ProtectedEndPoint("data::schema::update-schema-definition")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        /// <returns>Returns the updated schema definition or an error message if the operation fails.</returns>
        [HttpPut("info")]
        [ProtectedEndPoint("data::schema::update-schema")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [HttpDelete]
        [ProtectedEndPoint("data::schema::delete-schema-definition")]
        [ProducesResponseType(typeof(ServiceResponse<ActionResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
