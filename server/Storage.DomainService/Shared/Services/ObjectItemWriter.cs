...
namespace Storage.DomainService.Services
{
    public sealed class ObjectItemWriter : IObjectItemWriter
    {
        ...
        public Task DeleteAsync(string itemId, CancellationToken cancellationToken = default) => _repository.DeleteAsync(itemId, cancellationToken);
        public Task SetInheritanceAsync(string itemId, bool inherits, CancellationToken cancellationToken = default) => _repository.SetInheritanceAsync(itemId, inherits, cancellationToken);
